...
export class MenuComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.menuService
      ...
      .subscribe(
        (res: HttpResponse<IMenu[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInMenus(): void {
    this.eventSubscriber = this.eventManager.subscribe('menuListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IMenu[] | null, headers: HttpHeaders, page: number): void {
